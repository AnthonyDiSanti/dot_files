...
- id: 01KP392AFT04TBB050BP64A799 — title: Strengthen code_template doc maintenance and knowledge boundaries — owner: Codex (model: gpt-5.2-codex) — status: done — last update: 2026-04-13
- id: 01KP38CSK9997FQA0BVS6RF72D — title: Rework code_template around docs-first retrieval — owner: Codex (model: gpt-5.2-codex) — status: done — last update: 2026-04-13
- id: 01KFE9TA16TRQ9J3KH6371E30K — title: Populate AGENTS.md and /context docs with repo-specific details — owner: Codex (model: gpt-5.2-codex) — status: done — last update: 2026-01-18
