...
- Vim plugin updates (`plug.vim` snapshot / local Vim `plugged/`; Git prompt/completion comes from the active system Git install); Solarized editor colors via vim-solarized8, not `settings/solarized`
