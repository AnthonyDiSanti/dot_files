...
- Inner terminal capabilities use `tmux-256color`, RGB passthrough via `terminal-features`, and `focus-events on` so Vim and other TUIs can receive focus changes.
