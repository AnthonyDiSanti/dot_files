...
may still function in some 4.6 contexts, but current guidance favors adaptive
...
guide focused on Claude Opus 4.6 behavior that generalizes across skills; use
