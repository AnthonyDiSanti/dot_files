...
authoring model. Do not add model override instructions to prompt artifacts, and
do not change `agents/harnesses/*.yaml` from this maintenance pass.

If Codex cannot complete because of auth, sandboxing, account limits, model
capacity, preview access, or unavailable tools, leave the prompt artifact
